...
describe('ProcessTable virtualization', () => {
  beforeEach(() => {
    ...
    // 浏览器里滚动容器有真实内容高度）。mock 成内容总高 13800 = 300 行 × 46px、视口 600。
    vi.spyOn(window.HTMLElement.prototype, 'scrollHeight', 'get').mockReturnValue(13800);
  ...
  it('renders only a window of rows when row count > 100', () => {
    ...
    // 600px 视口 / 46px 行高 ≈ 13 行 + overscan，远小于 300 全量
