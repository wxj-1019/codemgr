...
export function mockIpc(
  ...
  const base = {
    ...
    fetchProcessEnv: vi.fn(() => Promise.resolve(null)),
    fetchCwd: vi.fn(() => Promise.resolve(null)),
    exportLabelRules: vi.fn(() => Promise.resolve(true)),
    importLabelRules: vi.fn(() => Promise.resolve(null)),
    listPlugins: vi.fn(() => Promise.resolve([])),
    requestDataSource: vi.fn(() => Promise.resolve()),
    onDataSourceResult: vi.fn(() => () => {}),
    getAppVersion: vi.fn(() => Promise.resolve('0.0.0')),
    getAutoLaunch: vi.fn(() => Promise.resolve(false)),
    setAutoLaunch: vi.fn(() => Promise.resolve(false)),
